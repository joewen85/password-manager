...
This project is indexed by GitNexus as **password-manager** (4633 symbols, 15030 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
